...
class Robot_position:                                   # kirjoitetaan luokkana
    ...
    def __init__(self):
        ...
        self.odom_sub = message_filters.Subscriber('/robot1/odom', Odometry)    # asento ja ground truth tieto paikasta, topic odom, tyyppi odometry
    ...
    def sensor_cb(self, us1_sub, us2_sub, us3_sub, us4_sub, us5_sub, us6_sub, odom_sub):
        ...
        yaw_radians = angles.angles.angles.normalize_angle_positive(yaw)
